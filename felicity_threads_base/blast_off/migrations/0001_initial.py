    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_question', models.ForeignKey(to='blast_off.Question')),
                ('submission_user', models.ForeignKey(related_name='blast_off_submission_related', to='base.User')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='blast_off.Question'),
